...
from . import IterableDataset, RemoteDataset, Sampler, SequentialSampler, RandomSampler, BatchSampler
from . import _utils
...
class _DatasetKind(object):
    ...
    def create_fetcher(kind, dataset, auto_collation, collate_fn, drop_last):
        if kind == _DatasetKind.Map:
            ...
            return _utils.fetch._RemoteDatasetFetcher(dataset, auto_collation, collate_fn, drop_last)
...
class DataLoader(object):
    ...
    def __init__(self, dataset, batch_size=1, shuffle=False, sampler=None,
        ...
        elif isinstance(dataset, RemoteDataset):
            self._dataset_kind = _DatasetKind.Remote
        else:

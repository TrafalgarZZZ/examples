...
class MyImageFolder(datasets.ImageFolder):
    ...
    def __init__(self, root, transform=None, target_transform=None, is_valid_file=None, batch_size=128):
    ...
    def __getitem__(self, index):
        ...
        self.timer += (transform_end - transform_start) * 1000.0
        self.timer_counter += 1
        if self.timer_counter % self.batch_size == 0:
            print("data load ends at %.5f" % transform_end)
